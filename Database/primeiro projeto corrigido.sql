...
CREATE TABLE Veiculo (
    ...
    status ENUM('DisponÃ­vel', 'Vendido') NOT NULL DEFAULT 'DisponÃ­vel'
);
...
CREATE TABLE Cliente (
    ...
    tipo_cliente ENUM('FÃ­sica', 'JurÃ­dica') NOT NULL,
...
('Allan', '12345678901', 'FÃ­sica', '4111111111111111'),
('Empresa X', '123456789012345', 'JurÃ­dica', '5222222222222222'),
('Allefy', '98765432100', 'FÃ­sica', '6333344444444444'),
('Patricia', '98765432101', 'FÃ­sica', '6333333333333335'),
('Ricardo', '98765432102', 'FÃ­sica', '6333333333333337');

-- FuncionÃ¡rios
INSERT INTO Funcionario (nome, salario, departamento) VALUES
('Carlos Souza', 2500.00, 'Vendas'),
('Ana Costa', 3000.00, 'AdministraÃ§Ã£o'),
...
-- Consulta de veÃ­culos vendidos
SELECT 
...
-- Valor mÃ©dio de todas as vendas
...
-- Valor mÃ©dio das vendas por funcionÃ¡rio
...
-- Se desejar incluir o nome do funcionÃ¡rio (supondo que exista a tabela Funcionario), vocÃª pode fazer um JOIN
CREATE VIEW media_vendas_por_funcionario AS
SELECT

...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public List<Filme> listar() {
        ...
        if (cursor.moveToFirst()) {
            do {
                Filme f = new Filme();
                f.title = cursor.getString(cursor.getColumnIndexOrThrow("titulo"));
                f.overview = cursor.getString(cursor.getColumnIndexOrThrow("sinopse"));
                f.vote_average = cursor.getDouble(cursor.getColumnIndexOrThrow("nota"));
                f.poster_path = cursor.getString(cursor.getColumnIndexOrThrow("poster"));
                lista.add(f);
